    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_industry', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='consultation_requests', to='consultation_requests.businessindustry', verbose_name='حوزه فعالیت')),
                ('consultant_service', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='consultation_requests', to='consultants.consultantservice', verbose_name='خدمت و مشاور انتخاب\u200cشده')),
                ('contact_role', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='consultation_requests', to='consultation_requests.contactrole', verbose_name='سمت درخواست\u200cدهنده')),
            ],
            options={
